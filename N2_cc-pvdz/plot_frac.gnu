...
plot '< paste pes_fci.dat pes_rhf.dat pes_rhf.dat'   using 1:(($6-$4)/($2-$4)) w l ls 1 notitle, \
     ...
     '< paste pes_fci.dat pes_rhf.dat pes_s10.e5.dat' using 1:(($6-$4)/($2-$4)) w l ls 3 notitle, \
     '< paste pes_fci.dat pes_rhf.dat pes_CIo1.dat'   using 1:(($6-$4)/($2-$4)) w l ls 5 notitle, \
     '< paste pes_fci.dat pes_rhf.dat pes_CIo1.5.dat' using 1:(($6-$4)/($2-$4)) w l ls 5 notitle, \
     '< paste pes_fci.dat pes_rhf.dat pes_CIo2.dat'   using 1:(($6-$4)/($2-$4)) w l ls 4 notitle, \
     '< paste pes_fci.dat pes_rhf.dat pes_CIo2.5.dat' using 1:(($6-$4)/($2-$4)) w l ls 5 notitle, \
     '< paste pes_fci.dat pes_rhf.dat pes_CIo3.dat'   using 1:(($6-$4)/($2-$4)) w l ls 4 notitle, \
     '< paste pes_fci.dat pes_rhf.dat pes_CIo3.5.dat' using 1:(($6-$4)/($2-$4)) w l ls 5 notitle, \
     '< paste pes_fci.dat pes_rhf.dat pes_CIo4.dat'   using 1:(($6-$4)/($2-$4)) w l ls 4 notitle, \
...
#    '< paste pes_fci.dat pes_rhf.dat pes_s12.e6.dat' using 1:(($6-$4)/($2-$4)) w l ls 3 notitle, \
