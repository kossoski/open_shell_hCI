...
set output 'plot_pes_nopt2_vs_pt2.eps'
...
fit [1.7:1.8] [*:*] f(x) 'pes_rhf.dat' u 1:($2) via a,b
#set label 1 'RHF+rPT2' at 1.70,-108.42 rotate by r(a) center tc ls 1 #font 'Verdana,20'
fit [1.8:2.6] [*:*] f(x) 'pes_s0.dat' u 1:($2) via a,b
#set label 31 'sCI0+rPT2' at 2.15,-108.658 rotate by r(a) center tc ls 8 #font 'Verdana,20'
fit [3.0:3.7] [*:*] f(x) 'pes_s2.dat' u 1:($2) via a,b
#set label 32 'sCI2+rPT2' at 3.65,-108.715 rotate by r(a) center tc ls 8 #font 'Verdana,20'
fit [2.9:3.1] [*:*] f(x) 'pes_s4.dat' u 1:($2) via a,b
#set label 33 'sCI4+rPT2' at 3.65,-108.878 rotate by r(a) center tc ls 8 #font 'Verdana,20'
fit [2.9:3.1] [*:*] f(x) 'pes_CISD.dat' u 1:($2) via a,b
#set label 2 'CISD+rPT2' at 3.1,-108.524 rotate by r(a) center tc ls 3 #font 'Verdana,20'
fit [2.9:3.1] [*:*] f(x) 'pes_CISDT.dat' u 1:($2) via a,b
#set label 3 'CISDT+rPT2' at 3.1,-108.588 rotate by r(a) center tc ls 3 #font 'Verdana,20'
fit [2.4:2.6] [*:*] f(x) 'pes_CISDTQ.dat' u 1:($2) via a,b
#set label 4 'CISDTQ+rPT2' at 2.6,-108.856 rotate by r(a) center tc ls 3 #font 'Verdana,20'
fit [3.6:3.8] [*:*] f(x) 'pes_CIo1.dat' u 1:($2) via a,b
#set label 11 'hCI1+rPT2' at 3.6,-108.326 rotate by r(a) center tc ls 4 #font 'Verdana,20'
fit [3.6:3.8] [*:*] f(x) 'pes_CIo2.dat' u 1:($2) via a,b
#set label 12 'hCI2+rPT2' at 3.65,-108.626 rotate by r(a) center tc ls 4 #font 'Verdana,20'
fit [3.6:3.8] [*:*] f(x) 'pes_CIo3.dat' u 1:($2) via a,b
#set label 13 'hCI3+rPT2' at 3.65,-108.836 rotate by r(a) center tc ls 4 #font 'Verdana,20'
fit [3.0:4.0] [*:*] f(x) 'pes_CIo4.dat' u 1:($2) via a,b
#set label 14 'hCI4+rPT2' at 3.65,-108.923 rotate by r(a) center tc ls 4 #font 'Verdana,20'
fit [3.0:4.0] [*:*] f(x) 'pes_fci.dat' u 1:($2) via a,b
#set label 20 'FCI' at 3.65,-108.980 rotate by r(a) center tc ls 2 #font 'Verdana,20'

plot 'pes_CISD_rpt2.dat'  w l ls 3 notitle, \
     'pes_CISDT_rpt2.dat'  w l ls 3 notitle, \
     'pes_CISDTQ_rpt2.dat'  w l ls 3 notitle, \
     'pes_s0_rpt2.dat'     w l ls 8 notitle, \
     'pes_s2_rpt2.dat'     w l ls 8 notitle, \
     'pes_s4_rpt2.dat'     w l ls 8 notitle, \
     'pes_CIo1_rpt2.dat'   w l ls 4 notitle, \
     'pes_CIo1.5_rpt2.dat' w l ls 5 notitle, \
     'pes_CIo2_rpt2.dat'   w l ls 4 notitle, \
     'pes_CIo2.5_rpt2.dat' w l ls 5 notitle, \
     'pes_CIo3_rpt2.dat'   w l ls 4 notitle, \
     'pes_CIo3.5_rpt2.dat' w l ls 5 notitle, \
     'pes_CIo4_rpt2.dat'   w l ls 4 notitle, \
     'pes_fci.dat'    w l ls 2 notitle

###################################################################################
###################################################################################

#plot 'pes_rhf_rpt2.dat'    w l ls 1 notitle, \
