...
plot 'r2.52053_ciexc.dat'   u 1:($2-efci)  w lp ls 3  notitle, \
     'r2.52053_oociexc.dat' u 1:($2-efci)  w l  ls 11 notitle, \
     'r2.52053_oociexc.dat' u 1:($2-efci)  w lp ls 13 notitle, \
     'r2.52053_cio.dat'     u 1:($2-efci)  w lp ls 4  notitle, \
     'r2.52053_oocio.dat'   u 1:($2-efci)  w l  ls 11 notitle, \
     'r2.52053_oocio.dat'   u 1:($2-efci)  w lp ls 14 notitle
