...
plot 'rpt2/det_xe_FCI.dat'     u 2:($3*bohr) w l  ls 2  notitle, \
     'rpt2/det_xe_CI.dat'      u 1:($3*bohr) w lp ls 3  notitle, \
     'rpt2/det_xe_CIs.dat'     u 1:($3*bohr) w lp ls 8  notitle, \
     'rpt2/det_xe_CIo.dat'     u 1:($3*bohr) w lp ls 4  notitle#, \
