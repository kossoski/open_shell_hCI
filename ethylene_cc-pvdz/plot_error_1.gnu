...
plot '< paste pes_fci.dat pes_rhf.dat'   using 1:($4-$2) w l ls 1 notitle, \
     '< paste pes_fci.dat pes_e2.dat' using 1:($4-$2) w l ls 3 notitle, \
     '< paste pes_fci.dat pes_e3.dat' using 1:($4-$2) w l ls 3 notitle, \
     '< paste pes_fci.dat pes_e4.dat' using 1:($4-$2) w l ls 3 notitle, \
     ...
     '< paste pes_fci.dat pes_ooCIe2.dat' using 1:($4-$2) w l ls 13 notitle, \
