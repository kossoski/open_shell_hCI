...
fit [2.0:2.5] [*:*] f(x) 'pes_rhf.dat' u 1:($2) via a,b
set label 1 'RHF' at 2.5,-2.00 rotate by r(a) center tc ls 1 #font 'Verdana,20'
fit [5.5:6.4] [*:*] f(x) 'pes_s0.dat' u 1:($2) via a,b
set label 31 'sCI0' at 5.5,-1.750 rotate by r(a) center tc ls 8 #font 'Verdana,20'
fit [5.0:6.0] [*:*] f(x) 'pes_s2.dat' u 1:($2) via a,b
set label 32 'sCI2' at 5.5,-1.838 rotate by r(a) center tc ls 8 #font 'Verdana,20'
fit [4.7:5.5] [*:*] f(x) 'pes_CISD.dat' u 1:($2) via a,b
set label 2 'CISD' at 5.2,-1.958 rotate by r(a) center tc ls 3 #font 'Verdana,20'
fit [5.2:5.8] [*:*] f(x) 'pes_CISDT.dat' u 1:($2) via a,b
set label 3 'CISDT' at 5.65,-1.980  rotate by r(a) center tc ls 3 #font 'Verdana,20'
fit [7.5:8.5] [*:*] f(x) 'pes_CIo1.dat' u 1:($2) via a,b
set label 11 'hCI1' at 8.5,-1.734  rotate by r(a) center tc ls 4 #font 'Verdana,20'
fit [7.5:8.5] [*:*] f(x) 'pes_CIo2.dat' u 1:($2) via a,b
set label 12 'hCI2' at 8.5,-1.964  rotate by r(a) center tc ls 4 #font 'Verdana,20'
fit [6.0:6.5] [*:*] f(x) 'pes_CIo3.dat' u 1:($2) via a,b
set label 13 'hCI3' at 6.3,-2.01 rotate by r(a) center tc ls 4 #font 'Verdana,20'
...
#fit [2.0:2.5] [*:*] f(x) 'pes_rhf.dat' u 1:($2) via a,b
#set label 1 'RHF' at 2.5,-2.00 rotate by r(a) center tc ls 1 #font 'Verdana,20'
#fit [5.1:5.6] [*:*] f(x) 'pes_ooCIS.dat' u 1:($2) via a,b
#set label 10 'oo-CIS' at 5.2,-1.826 rotate by r(a) center tc ls 3 #font 'Verdana,20'
#fit [5.8:6.5] [*:*] f(x) 'pes_ooCISD.dat' u 1:($2) via a,b
#set label 2 'oo-CISD' at 5.2,-1.989 rotate by r(a) center tc ls 3 #font 'Verdana,20'
#fit [8.0:8.5] [*:*] f(x) 'pes_ooCIo1.dat' u 1:($2) via a,b
#set label 12 'oo-hCI1' at 8.5,-1.987 rotate by r(a) center tc ls 4 #font 'Verdana,20'
#fit [7.5:8.5] [*:*] f(x) 'pes_fci.dat' u 1:($2) via a,b
#set label 20 'FCI' at 8.5,-2.01 rotate by r(a) center tc ls 2 #font 'Verdana,20'
