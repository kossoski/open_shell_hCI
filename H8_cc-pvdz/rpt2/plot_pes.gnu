...
#fit [3.0:4.0] [*:*] f(x) 'pes_rhf.dat' u 1:($2) via a,b
#set label 1 'RHF' at 3.0,-3.810 rotate by r(a) center tc ls 1 #font 'Verdana,20'
#fit [5.5:6.5] [*:*] f(x) 'pes_ooCIs0.dat' u 1:($2) via a,b
